...
Counsel replace many default functions like =<M-x>= to a better ivy compatible version.
...
Ivy-rich is additional functions for ivy.
...
Use company mode for display completions.
